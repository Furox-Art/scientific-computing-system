...
TR = 1.5
GLM_LOCK_FILE = "OPEN_SOURCE_V2_GLM_LOCK_V5_RUN_RECOVERY_2026-09-19.json"
HIGH_PASS = 1.0 / 128.0
FD_THRESHOLD = 0.5
...
def participant_mode(args) -> int:
    ...
    result = {
        "status":"P08_OPEN_SOURCE_V5_RUN_RECOVERY_PARTICIPANT_SELF_OTHER_GLM_COMPLETE",
        "participant":participant,
...
def aggregate_mode(args) -> int:
    ...
    result = {
        "status":"P08_OPEN_SOURCE_V5_RUN_RECOVERY_SELF_OTHER_GLM_ROI_COMPLETE",
        "lane":"open_source_secondary_sensitivity_only",
